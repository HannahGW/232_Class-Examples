...
source("../Rmaterials.April28/dexppop.R")
...
# try this - add a carrying capacity (dP/dt = 0 if P > carrying capacity)
...
```{r explicit}
source("../Rmaterials.April28/exppop.R")
...
# if we want to see how population evolves over time - generate a time series 
...
```{r}
source("../Rmaterials.April28/dexppop_play.R")
