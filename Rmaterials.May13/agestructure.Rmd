...
# start with an initial population, lets say 1 individual in each class (usisng vectors)
...
source("../Rmaterials.May13/evolve_pop.R")
...
# initial population parameters (in millions)
...
ggplot(china_tot, aes(decade, poptot))+geom_col()+labs(y="Total Population")
...
Sensitivity Of
  * total population after 3 decades
...
more 2 months - population fertility around 20%, survivability only 30%
