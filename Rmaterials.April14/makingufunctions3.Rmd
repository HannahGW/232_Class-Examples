...
```{r solar}
source("../Rmaterials.April14/solarpv.R")
solarpv

# read in R formatted data
load("../Rmaterials.April14/sierraczosolar.rda")
...
site2_average = site2df %>% group_by(year) %>% summarize(elect=mean(elect))
...
source("../Rmaterials.April14/compute_profit_frompower.R")
